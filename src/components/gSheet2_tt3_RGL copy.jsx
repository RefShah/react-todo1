...
export default class MyFirstGrid extends React.Component {
  ...
  constructor() {
    ...
    // 010118 Mon: ok
    // 010117 Sun: ok
    // let testDate = '4 jan 2019'; // wrong for all 3 shd be Wk0
    // let testDate = '5 jan 2017';
  ...
  render() {
    ...
    return (
      ...
      <ReactGridLayout className={this.getLayoutClass('Odd')} cols={6} rowHeight={30} width={1200}>
        ...
        {/* <div key="a5" className={this.getClass('Odd Fri Malay')} data-grid={{x: 5, y: 3, w: 1, h: 1, static: true}}>Malay</div>
        <div key="b5" className={this.getClass('Odd Fri Makan')} data-grid={{x: 5, y: 5, w: 1, h: 1, static: true}}>LUNCH</div> */}
        {/* <div key="c2" data-grid={{x: 2, y: 3, w: 5, h: 1, static: true}}>c</div> */}
      ...
      <ReactGridLayout className={this.getLayoutClass('Even')} cols={6} rowHeight={30} width={1200}>
        <div key="0T" className={this.getClass('0T')} data-grid={{x: 0, y: 0, w: 1, h: 1, static: true}}>{this.state.dateTdy}</div>
        <div key="a" className={this.getTimeClass('0750')} data-grid={{x: 0, y: 1, w: 1, h: 1, static: true}}>7:50am</div>
        <div key="b" className={this.getTimeClass('0750')} data-grid={{x: 0, y: 2, w: 1, h: 1, static: true}}>bT</div>
        <div key="c" className={this.getTimeClass('0750')} data-grid={{x: 0, y: 3, w: 1, h: 1, static: true}}>cT</div>
